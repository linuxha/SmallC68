...
extern char *symtab, *macn, *macq, *pline, *mline,  optimize,
    alarm, *glbptr, *line, *lptr, *cptr, *cptr2,  *cptr3,
    *locptr, msname[NAMESIZE],  pause,  quote[2];

extern int *wq,  ccode,  ch,  csp,  eof,  errflag,  iflevel,
    macptr,  nch, nxtlab,  op[16],  opindex,  opsize,  pptr,
    skiplevel,  *wqptr;

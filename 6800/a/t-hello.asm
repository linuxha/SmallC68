...
;*         while(putchar(s++));
cc2                            ;* Pseudo code
	FCB 4                  ;* LOAD WORD INDIRECT (ADDR IN REG)
	FDB putchar            ;* &putchar
	FCB 20                 ;* SUBTRACT REG FROM TOP OF STACK
	FCB 2                  ;* LOAD STACK ADDRESS + OFFSET INTO REG
	FDB 6                  ;* STORE WORD @ ADDRESS
	FCB 20                 ;* SUBTRACT REG FROM TOP OF STACK
	FCB 8                  ;* STORE WORD @ ADDRESS ON STACK
	FCB 62                 ;* ???
	FCB 16                 ;* RETURN TO CALLER
	FCB 64                 ;* ???
	FCB 22                 ;* DIVIDE THE TOP OF STACK BY REG --- RESULT IN REG.
	FCB 20                 ;* SUBTRACT REG FROM TOP OF STACK
	FCB 30                 ;* COMPLEMENT THE REGISTER
	FCB 34                 ;* TEST FOR NOT-EQUAL
	FDB 2                  ;* LOAD WORD @ ADDRESS
	FCB 26                 ;* AND .........
	FDB cc3                ;* &cc3
	FCB 24                 ;* INCLUSIVE OR THE TOP OF STACK AND REG.
	FDB cc2                ;* &cc2
cc3 
	FCB 34                 ;* TEST FOR NOT-EQUAL
	FDB 4                  ;* LOAD WORD INDIRECT (ADDR IN REG)
;* }
	FCB 34                 ;* TEST FOR NOT-EQUAL
	FDB 2                  ;* LOAD WORD @ ADDRESS
	FCB 32                 ;* SUBTRACT 1 FROM REG
#end include
;* main() {
